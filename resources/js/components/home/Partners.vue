<template>
  <v-container
    class="mt-3"
    :style="{'background-image':'url('+require('../assets/img/svg/partners.svg')+')'}"
    style="background-position:right bottom;background-size:250px"
  >
        ...
        <v-layout class="transparent">
          <v-flex xs12 sm10 class="elevation-0 transparent">
            <v-card class="elevation-0 pa-0 ma-0 transparent">
              <v-container grid-list-sm fluid class="pa-0 ma-0">
                <v-layout row wrap class="ma-0 pa-0">
                  <v-flex xs6 md2 d-flex class="white elevation-0">
                    <v-card
                      flat
                      tile
                      class="d-flex pa-2 ma-1 elevation-1"
